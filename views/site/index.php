...
<?php
        $_y1 = date('Y', $_SERVER['REQUEST_TIME'] ?? time()) - 1988;
        $_y2 = $_y1 + 1;
        $_years = [
          $_y1 => "平成{$_y1}年",
          $_y2 => "平成{$_y2}年",
...
?>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="form-inline">
<?php
        $_y1 = date('Y', $_SERVER['REQUEST_TIME'] ?? time()) - 1988 - 1;
        $_y2 = $_y1 + 1;
        $_years = [
          $_y1 => "平成{$_y1}年",
          $_y2 => "平成{$_y2}年",
...
<?php
        $_years = [];
        foreach (range(1, 64) as $_y) {
          $_years[$_y] = $_y === 1 ? '元年' : "{$_y}年";
        }
?>
